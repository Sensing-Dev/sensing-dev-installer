...
param (
    ...
    [Parameter(Mandatory=$false)]
    [string]$nativeINI= "scripts\pygobject_native.ini",
...
# Set the paths
$sourceDir = Convert-ToAbsolutePath -Path $sourceDir
$buildDir = Convert-ToAbsolutePath -Path $buildDir
$installDir = Convert-ToAbsolutePath -Path $installDir
$pkgConfigDir = Convert-ToAbsolutePath -Path $pkgConfigDir
$dependenciesDir = Convert-ToAbsolutePath -Path $dependenciesDir

# Optional: Convert nativeINI if provided
if ($nativeINI) {
    $nativeINI = Convert-ToAbsolutePath -Path $nativeINI
}
...
Write-Host "Meson compile"
Write-Host "======================================================"
meson compile -C . -v

Write-Host "Meson install"
Write-Host "======================================================"
meson install -C .
